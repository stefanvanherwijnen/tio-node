...
var vm_1__default = /*#__PURE__*/_interopDefaultLegacy(vm_1);
...
function checkEncoding(encoding) {
    if (!buffer_1__default['default'].Buffer.isEncoding(encoding)) {
...
function bigIntAndBufferInt64Check(bufferMethod) {
    ...
    if (typeof buffer_1__default['default'].Buffer.prototype[bufferMethod] === 'undefined') {
...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.compile = function () {
        ...
        this.compiled = vm_1__default['default'].runInNewContext(src, { Buffer: buffer_1__default['default'].Buffer });
    };
    Parser.prototype.compileEncode = function () {
        var src = '(function(obj) { ' + this.getCodeEncode() + ' })';
        this.compiledEncode = vm_1__default['default'].runInNewContext(src, { Buffer: buffer_1__default['default'].Buffer, SmartBuffer: smartbuffer.SmartBuffer });
    };
...
exports.TL_PTYPE_HEARTBEAT = TL_PTYPE_HEARTBEAT;
exports.TL_PTYPE_INVALID = TL_PTYPE_INVALID;
exports.TL_PTYPE_LOG = TL_PTYPE_LOG;
exports.TL_PTYPE_NONE = TL_PTYPE_NONE;
exports.TL_PTYPE_OTHER_ROUTING = TL_PTYPE_OTHER_ROUTING;
exports.TL_PTYPE_RPC_ERROR = TL_PTYPE_RPC_ERROR;
exports.TL_PTYPE_RPC_REP = TL_PTYPE_RPC_REP;
exports.TL_PTYPE_RPC_REQ = TL_PTYPE_RPC_REQ;
exports.TL_PTYPE_SOURCE = TL_PTYPE_SOURCE;
exports.TL_PTYPE_STREAM = TL_PTYPE_STREAM;
exports.TL_PTYPE_STREAM0 = TL_PTYPE_STREAM0;
exports.TL_PTYPE_TIMEBASE = TL_PTYPE_TIMEBASE;
exports.TL_PTYPE_USER = TL_PTYPE_USER;
exports.dataTypes = dataTypes;
exports.defaultPacketParser = defaultPacketParser;
...
exports.publishedDataParser = publishedDataParser;
exports.routingParser = routingParser;
exports.rpcPayloadParser = rpcPayloadParser;
exports.sourcePacketParser = sourcePacketParser;
exports.streamPacketParser = streamPacketParser;
exports.timebasePacketParser = timebasePacketParser;
